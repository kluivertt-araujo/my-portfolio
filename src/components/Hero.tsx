      ...
      <div className="container relative z-10 px-6">
        ...
        duration: 0.8
          ...
          delay: 0.5
            ...
            <span className="text-primary">React</span>. Transformo ideias em código limpo e escalável.
          </motion.p>
          ...
          delay: 0.7
            ...
            <a href="mailto:lucas@email.com" className="text-muted-foreground hover:text-primary transition-colors duration-300">
